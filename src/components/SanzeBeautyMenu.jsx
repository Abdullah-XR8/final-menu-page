    ...
    <section className={styles.offCanvasMenu}>
      <div className={styles.section1OfMenu}>
        <div className={styles.imgContainer}>
          <img
            src="./src/Assets/Sanze Dark Logo.png"
            alt="Sanze Dark Logo"
            width={40}
          />{" "}
          <div className={styles.buttons}>
            ...
            <div className={styles.btnContainerTop}>
              <button>
                <img src="./src/assets/Ellipse 51.png" alt="Close" width={90} />
              </button>
            </div>
          </div>
        </div>
      ...
      <div className={styles.sectionOfContactInfo}>
        <div className={styles.btnContainer}>
          <button>
            <img src="./src/assets/Ellipse 51.png" alt="Close" width={40} />
          </button>
        </div>
        ...
        <div className={styles.socialMediaLinks}>
          ...
          <div className={styles.socialMediaIcons}>
            <img src="src/assets/fb.png" alt="facebook" width={45} />
            <img src="src/assets/Insta.png" alt="instagram" width={45} />
            <img
              id={styles.Xcom}
